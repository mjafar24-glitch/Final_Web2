<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <div class="mb-3">
            <a class="btn btn-primary" href="{{ route('member.create') }}" role="button">Tambah</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm btn-detail"
                                    data-route="{{ route('member.show', $member) }}">
                                ...
                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-route="{{ route('member.destroy', $member) }}">
