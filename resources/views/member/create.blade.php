                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('member_code') is-invalid @enderror" type="text" id="member_code"
                            name="member_code" required value="{{ old('member_code') }}">
                        @error('member_code')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="Student" @selected(old('type') == 'Student')>Student (Siswa)</option>
                            <option value="Teacher" @selected(old('type') == 'Teacher')>Teacher (Guru)</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('is_active') is-invalid @enderror" id="is_active" name="is_active" required>
                            ...
                            <option value="0" @selected(old('is_active', 1) == 0)>Non-Aktif</option>
                        </select>
                        @error('is_active')
                            <div class="invalid-feedback">
                                {{ $message }}
